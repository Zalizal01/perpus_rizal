...
<h3>Data Buku</h3>
<hr>
<a href="index.php?content=tambah_buku">Tambah Data</a>
...
<table width="100%" align="center" border="1" cellpadding="5">
	...
	<tr>
		...
		<td>
			<a href="index.php?content=edit_buku&id=<?php echo $row['id_buku']?>">Edit</a>
			<a href="content/home/hapus_buku.php?id=<?php echo $row['id_buku']?>">Hapus</a>
		</td>
	</tr>
